      ...
      <section className="bg-white">
        <div className="mx-auto flex w-full max-w-[1350px] flex-col gap-0 px-4 pt-8 sm:gap-2 sm:px-6 lg:px-8 xl:px-0">
          <div className="flex items-center gap-3 text-[14px] font-semibold uppercase tracking-[0.08em] text-[#0F172A]">
            <span className="inline-flex h-[24px] items-center rounded-[6px] bg-[#FDECEC] px-3 text-[10px] font-extrabold text-[#111827] md:text-[12px]">
              MARKET TRENDS
            </span>
            <span className="h-1.5 w-1.5 rounded-full bg-[#CBD5E1]" />
            <span className="text-[12px] font-medium normal-case tracking-normal text-[#475569] md:text-[14px]">8 min read</span>
          </div>
          ...
          <div className="mt-4 w-[1350px] max-w-full font-['Lato'] text-[17.58px] text-[#334155] md:text-[20px]">
            <p>
          ...
          <div className="mt-8 w-full max-w-[1350px]">
            <h2 className="font-['Plus_Jakarta_Sans'] text-[24px] font-extrabold leading-[1.2] tracking-[-0.03em] text-[#111827] md:text-[30px]">
              The Connectivity Catalyst
            </h2>
            <p className="mt-5 font-['Lato'] text-[16px] leading-[30px] text-[#475569] md:text-[18px]">
          ...
          <section className="mt-10 flex w-full max-w-[1350px] items-start gap-6">
            <div className="mt-2 h-[200px] w-[6px] shrink-0 rounded-full bg-[#E51C23]" />
            <div className="min-w-0">
              ...
              <div className="mt-4 font-['Lato'] text-[14px] font-semibold leading-[24px] text-[#64748B] md:text-[16px]">
          ...
          <section className="mt-12 w-full max-w-[1350px]">
            <h3 className="font-['Plus_Jakarta_Sans'] text-[20px] font-extrabold leading-[1.2] tracking-[-0.03em] text-[#111827] md:text-[28px]">
              1. Wadala: The New BKC Alternative
            </h3>

            <p className="mt-6 max-w-[1180px] font-['Lato'] text-[16px] leading-[28px] text-[#475569] md:text-[18px] md:leading-[34px]">
            ...
            <ul className="mt-4 space-y-3 font-['Lato'] text-[12px] leading-[30px] text-[#334155] md:space-y-5 md:text-[18px]">
              <li className="flex items-start gap-4">
                <span className="mt-[9px] inline-flex h-[18px] w-[15.23px] shrink-0 items-center justify-center rounded-full bg-[#E51C23] text-[12px] font-black leading-none text-white md:h-[20px] md:w-[20px]">
                  ✓
                </span>
              ...
              <li className="flex items-start gap-4">
                ...
                <span className="md:hidden">Availability of luxury gated communities.</span>
                <span className="hidden md:inline">Availability of luxury gated communities with modern amenities.</span>
              </li>
            </ul>
            ...
            <figure className="mt-10 flex flex-col items-center">
              <img
                ...
                className="h-[225px] w-[1350px] max-w-full rounded-[24px] object-cover md:h-[500px]"
              />
              <figcaption className="mt-4 text-[12px] italic leading-[22px] text-[#64748B] md:text-[15px]">
            ...
            <div className="mt-10 w-full">
              <h4 className="font-['Plus_Jakarta_Sans'] text-[24px] font-extrabold leading-[1.2] tracking-[-0.03em] text-[#111827] md:text-[30px]">
                Strategic Investment Advice
              </h4>
              <p className="mt-4 max-w-[1280px] font-['Lato'] text-[16px] leading-[28px] text-[#475569] md:text-[18px] md:leading-[32px]">
              ...
              <div className="relative mt-7 overflow-hidden rounded-[24px] bg-[#0A1128] px-[38px] py-[40px] text-white shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] md:px-10 md:py-12">
                <div className="relative z-10 max-w-[620px]">
                  <h5 className="font-['Plus_Jakarta_Sans'] text-[24px] font-extrabold leading-[34px] tracking-[-0.03em] text-white md:text-[30px] md:leading-[1.15]">
                    Find your next investment in Mumbai
                  </h5>
                  <p className="mt-5 max-w-[520px] font-['Lato'] text-[16px] leading-[26px] text-[#94A3B8] md:text-[18px] md:leading-[32px]">
                    Get personalized property recommendations based on your investment profile
                    and budget from our expert advisors
                  </p>

                  <div className="mt-8 flex flex-col items-stretch gap-[14px] md:flex-row md:items-center md:gap-4">
                    <button
                      type="button"
                      className="inline-flex h-[52px] w-full items-center justify-center rounded-[14px] bg-white px-9 text-[14px] font-semibold text-[#111827] transition hover:bg-[#F8FAFC] md:h-[54px] md:w-auto md:text-[16px]"
                    >
                      Post Your Requirement
                    </button>
                    <button
                      type="button"
                      className="inline-flex h-[52px] w-full items-center justify-center rounded-[14px] border border-white/12 bg-white/5 px-9 text-[14px] font-semibold text-white transition hover:bg-white/10 md:h-[54px] md:w-auto md:text-[16px]"
                    >
                      Search Properties
                    </button>
                  </div>
              ...
              <div
                  className="pointer-events-none absolute bottom-0 right-0 hidden h-[100%] w-[42%] overflow-hidden md:block"
                  style={{
          ...
          <section className="mt-14 w-full max-w-[1350px]">
            <div className="flex items-end justify-between gap-6">
              ...
              <a href="/news-guide" className="hidden items-center gap-1 text-[16px] font-semibold text-[#E51C23] md:inline-flex">
                <span>View All</span>
