        ...
        className={[
          ...
          item.context === "auction"
            ...
            ? item.title === "Commercial Estate - Debt Resolution"
              ? "h-auto w-full min-w-0 rounded-[16px] shadow-[0_4px_20px_0_rgba(15,23,42,0.05)] sm:h-[596px]"
              : "h-auto w-full min-w-0 rounded-[16px] shadow-[0_4px_20px_0_rgba(15,23,42,0.05)] sm:h-[537px]"
            : item.context === "institutional"
